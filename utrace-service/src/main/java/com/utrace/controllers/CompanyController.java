...
public class CompanyController {
    ...
    if (existingCompany != null) {
        ...
        if (success) {
            return APIResponseUtil.successResponse("Company updated successfully", existingCompany);
        } else {
        ...
        if (success) {
            return APIResponseUtil.successResponse("Company added successfully", newCompany);
        } else {
